...
import * as uploader from "../../main/apps/chat/Components/Uploader";
...
export const createUserSettingsFirebase = (authUser) => async (dispatch, getState) => {
  ...
  const user = _.merge({}, guestUser, {
    ...
    data: {
      ...
      photoURL: uploader.fileURL !== null ? uploader.fileURL : 'https://i.ibb.co/yYJSYcc/profile.png',
...
const initialState = {
  ...
  data: {
    ...
    photoURL: 'https://i.ibb.co/yYJSYcc/profile.png',
