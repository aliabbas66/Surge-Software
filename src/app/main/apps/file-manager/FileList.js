...
function FileList(props) {
    ...
    return (
        <motion.div
            ...
            animate={{y: 0, opacity: 1, transition: {delay: 0.3}}} className="relative parnt"
        >
            <LoadingOverlay
                className={props.iS ? "fixStyling" : ''}
                active={props.iS}
                spinner
                text={ 'Uploading your file...' + props.per + '% done' }
            >
            </LoadingOverlay>
            ...
            {
                props?.data?.length > 0 ?
                    <div className="uploadBox" id="my-form">
