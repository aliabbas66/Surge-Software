...
function ChatsSidebar(props) {
  ...
  let filteredChatList = getFilteredArray([...chatListContacts], searchText);
      ...
      <FuseScrollbars className="overflow-y-auto flex-1">
        <List className="w-full">
          <audio id="noti" controls>
            <source src="https://firebasestorage.googleapis.com/v0/b/surge-bb99e.appspot.com/o/notification.mp3?alt=media&token=e21fed8d-7af9-49fa-af31-f0615616d172" type="audio/ogg" />
            <source src="https://firebasestorage.googleapis.com/v0/b/surge-bb99e.appspot.com/o/notification.mp3?alt=media&token=e21fed8d-7af9-49fa-af31-f0615616d172" type="audio/mpeg" />
          </audio>
          <motion.div
