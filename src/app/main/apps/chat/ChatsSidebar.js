            ...
            <AppBar position="static" color="default" elevation={0}>
                <Toolbar className="flex justify-between items-center px-4">
                    ...
                    <div>
                        ...
                        >
                            <MenuItem component={Link} to="/pages/profile" onClick={handleMoreMenuClose}>Profile</MenuItem>
            ...
            <FuseScrollbars className="overflow-y-auto flex-1">
                <List className="w-full">
                    <audio id="noti" controls>
                        <source
                            src="https://firebasestorage.googleapis.com/v0/b/surge-bb99e.appspot.com/o/Music%2Fnotification.mp3?alt=media&token=ffb4cd68-6913-4eb8-9292-8a5c8d825b80"
                            type="audio/ogg"/>
                        <source
                            src="https://firebasestorage.googleapis.com/v0/b/surge-bb99e.appspot.com/o/Music%2Fnotification.mp3?alt=media&token=ffb4cd68-6913-4eb8-9292-8a5c8d825b80"
                            type="audio/mpeg"/>
